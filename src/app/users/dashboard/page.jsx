...
const Page = async () => {
  ...
  return (
    <div className="mt-8 text-white flex flex-col justify-center items-center">
      ...
      <Image className="mt-6 transition-all duration-800 ease-in-out hover:border-violet-600 hover:shadow-lg hover:shadow-violet-600/50" src={user?.image} alt="..." width={250} height={250} />
